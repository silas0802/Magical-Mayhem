...
public class UnitClass : ScriptableObject
{
    ...
    [SerializeField, Tooltip("These are the spell types that the class may equip")] private SpellUseType[] AllowedSpells = new SpellUseType[6];

    [SerializeField, Tooltip("Do you actually need this explained????")] private int MaxHealth;

    public SpellUseType[] allowedSpells => this.AllowedSpells;
